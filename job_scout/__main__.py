...
def main(argv: List[str] | None = None) -> int:
    ...
    if args.command == "run":
        ...
        run_summary = {
            ...
            "digest_top_matches_count": notification.digest_top_matches_count,
            "digest_data_only_count": notification.digest_data_only_count,
            "digest_count": notification.digest_count,
            ...
            "hard_rejected_count": summary.hard_rejected_count,
            "soft_penalized_count": summary.soft_penalized_count,
            "top_penalties": summary.top_penalties or {},
            "top_hard_rejects": summary.top_hard_rejects or {},
            "avg_score": round(summary.avg_score, 2),
            "max_score": summary.max_score,
            "strict_match_min_score": summary.strict_match_min_score,
            "strict_match_max_score": summary.strict_match_max_score,
            "selected_min_score": notification.selected_min_score,
            "selected_max_score": notification.selected_max_score,
            "digest_min_score": notification.digest_min_score,
            "digest_max_score": notification.digest_max_score,
