...
def fetch_dummy(since_days: int) -> list[SourceJob]:
    ...
    postings = [
        ...
        SourceJob(
            id="dummy-it-006",
            source="dummy",
            company="Mediterraneo Bank",
            title="Data Governance Specialist Lead",
            location_text="Milan, Italy",
            location_country="Italy",
            location_city="Milan",
            remote_type="hybrid",
            url="https://example.com/jobs/mediterraneo-bank-data-governance-lead",
            posted_at=now - timedelta(days=2, hours=2),
            salary_text=None,
            currency=None,
            tags=["data governance", "risk"],
            description_snippet="Lead data governance, lineage, and stewardship programs.",
        ),
        SourceJob(
            id="dummy-eu-007",
            source="dummy",
            company="Nordic FinTech",
            title="Metadata Management Lead",
            location_text="Helsinki, Finland",
            location_country="Finland",
            location_city="Helsinki",
            remote_type="onsite",
            url="https://example.com/jobs/nordic-fintech-metadata-lead",
            posted_at=now - timedelta(days=3, hours=6),
            salary_text=None,
            currency=None,
            tags=["metadata", "data catalog"],
            description_snippet="Own metadata management and data catalog standards.",
        ),
        SourceJob(
            id="dummy-eu-008",
            source="dummy",
            company="Alpine Data Co.",
            title="Data Steward Lead",
            location_text="Vienna, Austria",
            location_country="Austria",
            location_city="Vienna",
            remote_type="hybrid",
            url="https://example.com/jobs/alpine-data-steward-lead",
            posted_at=now - timedelta(days=4, hours=3),
            salary_text=None,
            currency=None,
            tags=["data stewardship", "quality"],
            description_snippet="Drive data quality and stewardship across domains.",
        ),
        SourceJob(
            id="dummy-eu-009",
            source="dummy",
